...
| `network_alerts_service.py` | 267 | `/networkAlerts`: resolves the observer (hex or npub), builds the per-observer property keys, maps graph rows → panel payload. Neo4j-only, no SQL. |
