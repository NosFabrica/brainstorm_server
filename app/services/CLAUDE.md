...
| `billing_visibility_service.py` | 171 | What nobody has settled: the divergence report an operator reads, and the accounting CSV. Read-only over the billing tables. |
